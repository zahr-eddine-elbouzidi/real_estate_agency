...
$upload_dir_current_by_user ='';
$current_path_by_user ='';

$username= '<script>document.write( sessionStorage.getItem("keySessionPHP"));</script>';
if($username != null && $username != ''){
	$upload_dir_current_by_user ='/js/source/zahr/';
 }
...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => $upload_dir_current_by_user,
