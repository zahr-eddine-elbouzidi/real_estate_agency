...
.controller('AppCtrl', ['$scope','$rootScope','$http', '$translate', '$localStorage', '$window','$state','API_URL', 
  ...
  /*  $http.get(API_URL+'/candidat/getCandidatPostuledAction/'+$rootScope.user)
            .success(function(response, status, headers, config) { 
    	console.log(response.data);
    	console.log(response.isPostuled);
    });*/
  ...
  $scope.initializeAll = function(){

    var x = confirm('Étes-vous sûr?');
    if(x){
      $http.get(API_URL+'/agent/getInitializeAll/'+$rootScope.user).
      success(function(data, status, headers, config) {
  ...
  $scope.initializeUsers = function(){
    ...
    var x = confirm('Étes-vous sûr?');
    if(x){
      $http.get(API_URL+'/agent/getInitializeUsers/'+$rootScope.user).
      success(function(data, status, headers, config) {
