           ...
           <div class="wrapper-md" >
             ...
             <form  class="form-horizontal" ng-submit="saveChange()" >
               ...
               <div class="form-group">
                ...
                <div class="col-lg-8">
                 <input id="nom" type="date" name="sessionEdit.session_date" class="form-control"  required="true" ng-model="sessionEdit.session_date" />
              ...
              <div class="form-group">
                ...
                <div class="col-lg-8">
                 <input id="nom" type="date" name="sessionEdit.session_end" class="form-control"  required="true" ng-model="sessionEdit.session_end" />
