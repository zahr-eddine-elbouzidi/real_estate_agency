  ...
  <div class="app-footer wrapper b-t bg-light">
    ...
    <span><small class="text-muted">I.E.W | International Education Window.</span><br><span> Tous droits réservés.</span> &copy; <?php echo date('Y'); ?> <br><span><small class="text-muted">Version {{app.version}}</small></span></small></span>
  </div>
  <!-- / footer -->
