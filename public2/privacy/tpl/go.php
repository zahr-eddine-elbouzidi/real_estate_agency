...
<div class="row" >
 ...
 <div ui-sref="app.dashboard-v1" style="cursor: pointer;" class="col-md-3"   >
     ...
     <div ui-sref="app.contact" style="cursor: pointer;" class="col-md-3"  ng-if="admin && adminName=='admin' && (role=='Superviseur' || role=='SuperviseurT')">
      <a ui-sref="app.go" >
      <div class="panel panel-white">

        <div class="panel-heading">
              <div class="clearfix">
                <a ui-sref="app.contact" class="pull-left thumb-md avatar b-3x m-r">
                  <img src="img/contact.png" alt="...">
                </a>
                <div class="clear">
                  <div class="h4 m-t m-b-xs">G. Contacts</div>
                  <small class="text-muted">La gestion des contact, Tel,Email etc ...</small>
                </div>
        ...
        <div class="panel-heading">
              <div class="clearfix">
                ...
                <div class="clear">
                  ...
                  <small class="text-muted">La gestion des catégories, ajout , modifications ...</small>
                </div>
      ...
      <div class="panel panel-white">
        ...
        <div class="panel-heading">
              <div class="clearfix">
                ...
                <div class="clear">
                  <div class="h4 m-t m-b-xs">G. Sous catégories</div>
                  <small class="text-muted">La gestion de menus, ajout , modifications ...</small>
                </div>
