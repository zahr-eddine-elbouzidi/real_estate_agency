     ...
     //   $locationProvider.html5Mode(true);
          ...
          $stateProvider
              ...
              .state('app.partenaires', {
                url: '/partenaires',
                templateUrl: 'tpl/modules/partenaires/index.php',
                  data: {
                    requireLogin: true, // this property will apply to all children of 'app',
                    requiredRole: ['admin'],
                    requiredType: ['SuperviseurT','Ministère']
                  ...
                  resolve: {
                      deps: ['uiLoad','$ocLazyLoad',
                        function( uiLoad ,$ocLazyLoad){
                           ...
                           return $ocLazyLoad.load('angularFileUpload').then(
                              function(){
                                  return uiLoad.load( ['js/controllers/libs/modules/partenaires/partenaires.js',
                                               'vendor/libs/moment.min.js'] );
                              }
                            );
                      }]
            ...
            .state('app.addPartenaire', {
              url: '/partenaires/add',
              templateUrl: 'tpl/modules/partenaires/add.php',
                data: {
                  requireLogin: true, // this property will apply to all children of 'app',
                  requiredRole: ['admin'],
          ...
          .state('app.editPartenaires', {
            url: '/partenaires/edit/:id',
            templateUrl: 'tpl/modules/partenaires/edit.php',
              data: {
                requireLogin: true,
                requiredRole: ['admin'],
                requiredType: ['SuperviseurT']
              ...
              .state('app.modes', {
                url: '/modes-paiements',
                templateUrl: 'tpl/modules/modes/index.php',
                  data: {
                    requireLogin: true, // this property will apply to all children of 'app',
                    requiredRole: ['admin'],
                    requiredType: ['SuperviseurT','Ministère']
                  ...
                  resolve: {
                      deps: ['uiLoad','$ocLazyLoad',
                        function( uiLoad ,$ocLazyLoad){
                           ...
                           return $ocLazyLoad.load('angularFileUpload').then(
                              function(){
                                  return uiLoad.load( ['js/controllers/libs/modules/modes/modes.js',
                                               'vendor/libs/moment.min.js'] );
                              }
                            );
                      }]
            ...
            .state('app.addMode', {
                url: '/modes-paiements/add',
                templateUrl: 'tpl/modules/modes/add.php',
                  data: {
                    requireLogin: true, // this property will apply to all children of 'app',
                    requiredRole: ['admin'],
                    requiredType: ['SuperviseurT']
            ...
            .state('app.editMode', {
                url: '/modes-paiements/edit/:id',
                templateUrl: 'tpl/modules/modes/edit.php',
                  data: {
                    requireLogin: true,
                    requiredRole: ['admin'],
                    requiredType: ['SuperviseurT']
            ...
            .state('app.filieres', {
              url: '/filieres',
              templateUrl: 'tpl/modules/filieres/index.php',
                data: {
                  requireLogin: true, // this property will apply to all children of 'app',
                  requiredRole: ['admin'],
                  requiredType: ['SuperviseurT','Ministère']
                ...
                resolve: {
                    deps: ['uiLoad','$ocLazyLoad',
                      function( uiLoad ,$ocLazyLoad){
                         ...
                         return $ocLazyLoad.load('angularFileUpload').then(
                            function(){
                                return uiLoad.load( ['js/controllers/libs/modules/filieres/filieres.js',
                                             'vendor/libs/moment.min.js'] );
                            }
                          );
                    }]
          ...
          .state('app.addFiliere', {
              url: '/filieres/add',
              templateUrl: 'tpl/modules/filieres/add.php',
                data: {
                  requireLogin: true, // this property will apply to all children of 'app',
                  requiredRole: ['admin'],
                  requiredType: ['SuperviseurT']
          ...
          .state('app.editFiliere', {
              url: '/filieres/edit/:id',
              templateUrl: 'tpl/modules/filieres/edit.php',
                data: {
                  requireLogin: true,
                  requiredRole: ['admin'],
                  requiredType: ['SuperviseurT']
          ...
          .state('app.calendrier', {
            url: '/calendriers/:id',
            templateUrl: 'tpl/modules/calendriers/index.php',
              data: {
                requireLogin: true, // this property will apply to all children of 'app',
                requiredRole: ['admin'],
                requiredType: ['SuperviseurT','Ministère']
              ...
              resolve: {
                  deps: ['uiLoad','$ocLazyLoad',
                    function( uiLoad ,$ocLazyLoad){
                       ...
                       return $ocLazyLoad.load('angularFileUpload').then(
                          function(){
                              return uiLoad.load( ['js/controllers/libs/modules/calendrier/calendrier.js',
                                           'vendor/libs/moment.min.js'] );
                          }
                        );
                  }]
        ...
        .state('app.inscriptions', {
          url: '/inscriptions/:id',
          templateUrl: 'tpl/modules/inscriptions/index.php',
            data: {
              requireLogin: true, // this property will apply to all children of 'app',
              requiredRole: ['admin'],
              requiredType: ['SuperviseurT','Ministère']
            ...
            resolve: {
                deps: ['uiLoad','$ocLazyLoad',
                  function( uiLoad ,$ocLazyLoad){
                     ...
                     return $ocLazyLoad.load('angularFileUpload').then(
                        function(){
                            return uiLoad.load( ['js/controllers/libs/modules/inscriptions/inscriptions.js',
                                         'vendor/libs/moment.min.js'] );
                        }
                      );
                }]
                    ...
                    resolve: {
                        deps: ['uiLoad','$ocLazyLoad',
                          function( uiLoad ,$ocLazyLoad){
                             ...
                             return $ocLazyLoad.load('angularFileUpload').then(
                                function(){
                                    return uiLoad.load( ['js/controllers/libs/modules/candidat/candidat/candidat.js',
                                                 'vendor/libs/moment.min.js'] );
                                }
                              );
                        }]
