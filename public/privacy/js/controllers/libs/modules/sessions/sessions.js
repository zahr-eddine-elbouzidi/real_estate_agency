        ...
        **/
         ...
         **/
         ...
         $scope.getElement=function(session){
           ...
           $state.go('app.editSession', { id : session.id_session });
 ...
 $scope.selectedReport= function(id , value){
        ...
        $scope.saveSession = function() {
         ...
         {
          'nom_session':  $scope.session.nom_session,
          'created_by':$rootScope.user,
  ...
  $rootScope.loader = false;
        ...
        **/
        ...
        .success(function(response, status, headers, config) {
          ...
          $scope.sessionEdit.nom_session =  response.data.nom_session;
         ...
         **/
         $scope.saveChange=function(){
          ...
          $http({
            ...
            method:'POST',
            data:{
              'nom_session':  $scope.sessionEdit.nom_session,
              'created_by':$rootScope.user
