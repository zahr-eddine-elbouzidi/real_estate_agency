...
/*$http.get(API_URL+'/hire/getHireById/'+$stateParams.id_hire)
  ...
  .success(function(response, status, headers, config) {
         ...
         if($stateParams.slug === "divers"){
          ...
          if(angular.isDefined($scope.candidat)){
               ...
               if($scope.candidat.niveau == "BAC+8M"){ //Candidat-PESAM = BAC+8M
                ...
                { id: 1,      name: 'Demande manuscrite' , name_ar : 'طلب خطي'},
                { id: 2,      name: 'Curriculum Vitae' , name_ar : 'السيرة الداتية'},
                { id: 3,      name: 'Autorisation de participation au concours (Fonctionnaires)' ,name_ar : 'الترخيص باجتياز المباراة بالنسبة للموظفين'},
   ...
   $scope.change= function(value){
    ...
    if(angular.isDefined(value)){
      ...
      if($scope.candidat.niveau === 'BAC'){
       ...
       if(value ==="Marocain"){
        ...
        { id: 1,      name: 'DUT,DTS,BTS,DEUG ou un diplôme équivalent' , name_ar : 'دبلوم تقني متخصص أو ما يعادله'}
        ];
        ...
        { id: 1,      name: 'DUT,DTS,BTS,DEUG ou un diplôme équivalent' , name_ar : 'دبلوم تقني متخصص أو ما يعادله'},
        { id: 2,      name: 'Arrêté d\'équivalence du DUT,DTS,BTS,DEUG ou un diplôme équivalent',name_ar : 'قرار المعادلة لدبلوم تقني متخصص أو ما يعادله'},
        { id: 3,      name: 'Lettre d\'équivalence du DUT,DTS,BTS,DEUG ou un diplôme équivalent',name_ar : 'رسالة المعادلة لدبلوم تقني متخصص أو ما يعادله'}
    ...
    if(value ==="Marocain"){
      ...
      { id: 1,      name: 'Licence ou un diplôme équivalent' , name_ar : 'دبلوم الإجازة أو ما يعادله'},
      ];
      ...
      { id: 1,      name: 'Licence ou un diplôme équivalent' , name_ar : 'دبلوم الإجازة أو ما يعادله'},
      { id: 2,      name: 'Arrêté d\'équivalence de la licence' , name_ar : 'قرار المعادلة لدبلوم الإجازة أو ما يعادلها'},
      { id: 3,      name: 'Lettre d\'équivalence de la licence' , name_ar : 'رسالة المعادلة لدبلوم الإجازة أو ما يعادلها'}
   ...
   if(value ==="Marocain"){
    ...
    { id: 1,      name: 'Ingénierie ou un diplôme équivalent' , name_ar : 'دبلوم مهندس دولة أو ما يعادله'} 
    ];
    ...
    { id: 1,      name: 'Ingénierie ou un diplôme équivalent', name_ar : 'دبلوم مهندس دولة أو ما يعادله'},
    { id: 2,      name: 'Arrêté d\'équivalence du diplôme ingénieur', name_ar : 'قرار المعادلة لدبلوم مهندس دولة أو ما يعادله'},
    { id: 3,      name: 'Lettre d\'équivalence du diplôme ingénieur', name_ar : 'رسالة المعادلة لدبلوم مهندس دولة أو ما يعادله'} 
 ...
 if(value ==="Marocain"){
  ...
  { id: 1,      name: 'Master ou un diplôme équivalent', name_ar : 'دبلوم الماستر أو ما يعادله'} 
  ];
  ...
  { id: 1,      name: 'Master ou un diplôme équivalent', name_ar : 'دبلوم الماستر أو ما يعادله'},
  { id: 2,      name: 'Arrêté d\'équivalence du master', name_ar : 'قرار المعادلة لدبلوم الماستر أو ما يعادله'},
  { id: 3,      name: 'Lettre d\'équivalence du master', name_ar : 'رسالة المعادلة لدبلوم الماستر أو ما يعادله'} 
 ...
 $scope.types = [
 { id: 1,      name: 'Thèse' , name_ar : 'الأطروحة'},
 ...
 $scope.SLUG = "";
     ...
     /* $scope.pdfName = 'Relativity: The Special and General Theory by Albert Einstein';
      ...
      $scope.uploadImage = function (item) {
        alert($scope.up.specialite_diplome);
