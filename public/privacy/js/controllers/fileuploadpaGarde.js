...
/*$http.get(API_URL+'/hire/getHireById/'+$stateParams.id_hire)
  ...
  .success(function(response, status, headers, config) {
    ...
    $scope.loadFileTypes = function(){
      ...
      .success(function(response, status, headers, config) {
        ...
        if(angular.isDefined(response.data)){
               ...
               if($rootScope.role == "Candidat-PESAM"){

                $scope.types = [

                { id: 1,      name: 'Demande manuscrite'},
                { id: 2,      name: 'Curriculum Vitae'},
                { id: 3,      name: 'Autorisation de participation au concours (Fonctionnaires)'},
                { id: 4,      name: 'Carte d\'Identité Nationale'},
                { id: 5,      name: 'Déclaration sur l\'honneur'},
                { id: 6,      name: 'Attestation de résidanat'},
                
                ];

              }else if($rootScope.role == "Candidat-PESAF"){
             ...
             if($scope.candidat.is_fonctionnaire == 1){
               $scope.types.push({ id: 56,      name: 'Attestation du Handicap'});
             }
            ...
            if($scope.auth === true){
             ...
             if($rootScope.role == "Candidat-PESAM"){
              ...
              { id: 1,      name: 'Demande manuscrite'},
              { id: 2,      name: 'Curriculum Vitae'},
              { id: 3,      name: 'Autorisation Exceptionnelle pour les candidats non fonctionnaire (Condition d\'âge)'},
              { id: 4,      name: 'Carte d\'Identité Nationale'},
              { id: 5,      name: 'Déclaration sur l\'honneur'},
              { id: 6,      name: 'Attestation de résidanat'},
           ...
           if($rootScope.role == "Candidat-PESAM"){
            ...
            { id: 1,      name: 'Demande manuscrite'},
            { id: 2,      name: 'Curriculum Vitae'},
            { id: 3,      name: 'Carte d\'Identité Nationale'},
            { id: 4,      name: 'Déclaration sur l\'honneur'},
            { id: 5,      name: 'Attestation de résidanat'},
   ...
   $scope.change= function(value){
    ...
    if(angular.isDefined(value)){
      ...
      if($scope.candidat.niveau === 'BAC'){
        ...
        if(value ==="Marocain"){
          ...
          { id: 1,      name: 'Baccalauréat ou un diplôme équivalent'}
          ];
          ...
          { id: 1,      name: 'Baccalauréat ou un diplôme équivalent'},
          { id: 2,      name: 'Arrêté d\'équivalence du Baccalauréat ou un diplôme équivalent'},
          { id: 3,      name: 'Lettre d\'équivalence du Baccalauréat ou un diplôme équivalent'}
       ...
       if(value ==="Marocain"){
        ...
        { id: 1,      name: 'DUT,DTS,BTS,DEUG ou un diplôme équivalent'}
        ];
        ...
        { id: 1,      name: 'DUT,DTS,BTS,DEUG ou un diplôme équivalent'},
        { id: 2,      name: 'Arrêté d\'équivalence du DUT,DTS,BTS,DEUG ou un diplôme équivalent'},
        { id: 3,      name: 'Lettre d\'équivalence du DUT,DTS,BTS,DEUG ou un diplôme équivalent'}
     ...
     if(value ==="Marocain"){
      ...
      { id: 1,      name: 'Diplôme de Technicien (4ème grade) ou un diplôme équivalent'}
      ];
      ...
      { id: 1,      name: 'Diplôme de Technicien (4ème grade) ou un diplôme équivalent'},
      { id: 2,      name: 'Arrêté d\'équivalence du Diplôme de Technicien (4ème grade) ou un diplôme équivalentt'},
      { id: 3,      name: 'Lettre d\'équivalence du Diplôme de Technicien (4ème grade) ou un diplôme équivalent'}
    ...
    if(value ==="Marocain"){
      ...
      { id: 1,      name: 'Licence ou un diplôme équivalent'},
      ];
      ...
      { id: 1,      name: 'Licence ou un diplôme équivalent'},
      { id: 2,      name: 'Arrêté d\'équivalence de la licence'},
      { id: 3,      name: 'Lettre d\'équivalence de la licence'}
   ...
   if(value ==="Marocain"){
    ...
    { id: 1,      name: 'Ingénieurie ou un diplôme équivalent'} 
    ];
    ...
    { id: 1,      name: 'Ingénieurie ou un diplôme équivalent'},
    { id: 2,      name: 'Arrêté d\'équivalence du diplôme ingénieur'},
    { id: 3,      name: 'Lettre d\'équivalence du diplôme ingénieur'} 
 ...
 if(value ==="Marocain"){
  ...
  { id: 1,      name: 'Master ou un diplôme équivalent'} 
  ];
  ...
  { id: 1,      name: 'Master ou un diplôme équivalent'},
  { id: 2,      name: 'Arrêté d\'équivalence du master'},
  { id: 3,      name: 'Lettre d\'équivalence du master'} 
 ...
 $scope.change= function(value){
  ...
  if(angular.isDefined(value)){
   ...
   if(value ==="Marocain"){
    ...
    $scope.types = [
    { id: 1,      name: 'Baccalauréat ou un diplôme équivalent'},
    { id: 2,      name: 'Licence ou un diplôme équivalent'},
    { id: 3,      name: 'Master ou un diplôme équivalent'},
    { id: 4,      name: 'Doctorat ou un diplôme équivalent'}
    ...
    { id: 1,      name: 'Baccalauréat ou un diplôme équivalent'},
    { id: 2,      name: 'Arrêté d\'équivalence du baccalauréat'},
    { id: 3,      name: 'Lettre d\'équivalence du baccalauréat'},
    { id: 4,      name: 'Licence ou un diplôme équivalent'},
    { id: 5,      name: 'Arrêté d\'équivalence de la licence'},
    { id: 6,      name: 'Lettre d\'équivalence de la licence'},
    { id: 7,      name: 'Master ou un diplôme équivalent'},
    { id: 8,      name: 'Arrêté d\'équivalence du master'},
    { id: 9,      name: 'Lettre d\'équivalence du master'},
    { id: 10,     name: 'Doctorat ou un diplôme équivalent'},
    { id: 11,     name: 'Arrêté d\'équivalence du doctorat'},
    { id: 12,     name: 'Lettre d\'équivalence du doctorat'}
 ...
 $scope.types = [
 { id: 1,      name: 'Attestations d\'expérience'}
...
$scope.deleteJury = function(id) {
  ...
  $scope.displayFile =  function(file_id){
    ...
    $rootScope.loader = true;
    $http.get(API_URL+'/candidat/getJury/'+$rootScope.user+'/'+file_id+'/'+$stateParams.id_hire)
    .success(function(data, status, headers, config) {
      if(angular.isDefined(data.data)){
