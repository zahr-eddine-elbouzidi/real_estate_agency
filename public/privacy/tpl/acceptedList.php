...
$titleType = (isset($type) && $type == 'postuled') ? 'Liste des candidats' : 'Liste des candidats convoqués';
$titleType_ar = (isset($type) && $type == 'postuled') ? 'لائحة المترشحين ' : 'لائحة المترشحين المقبولين لاجتياز الاختبار الكتابي ';
