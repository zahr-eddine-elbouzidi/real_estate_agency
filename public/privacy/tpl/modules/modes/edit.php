...
<div class="wrapper-md" ng-controller="ModeEditCtrl">
           ...
           <div class="wrapper-md" >
             ...
             <form  class="form-horizontal" ng-submit="saveChange()" >
               ...
               <div class="form-group">
                ...
                <div class="col-lg-8">
                 <input id="nom" type="text" name="modeEdit.nom_mode" class="form-control"  required="true" ng-model="modeEdit.nom_mode" />
