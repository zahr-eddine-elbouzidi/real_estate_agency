  ...
  <div class="table-responsive">
    ...
    <div style="float: right;">
     <!-- <label class="col-sm-2 control-label" translate="operations.VIEW" >Afficher</label>-->
        ...
        <table  class="table table-striped" >
         ...
         <tr>
           <th>
            <a    ng-click="sortType = 'nom_session'; sortReverse = !sortReverse"  >
             <span  > Session</span>
             <span ng-show="sortType == 'nom_session' && !sortReverse" class="fa fa-caret-down"></span>
             <span ng-show="sortType == 'nom_session' && sortReverse" class="fa fa-caret-up"></span>
           </a>
         </th>
   ...
   <tr ng-repeat="session in sessions.slice(((currentPage-1)*itemsPerPage), ((currentPage)*itemsPerPage)) | filter: search | orderBy:sortType:sortReverse">
    ...
    <td  ng-show="role == 'SuperviseurT'"> 
     ...
     <a   data-record-id="{{session.id_session}}" data-record-title="{{session.nom_session}}" data-toggle="modal" data-target="#confirm-delete" 
